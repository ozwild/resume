...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _NavClass = __webpack_require__(327);

	var _NavClass2 = _interopRequireDefault(_NavClass);

	var _ContentNotesClass = __webpack_require__(329);

	var _ContentNotesClass2 = _interopRequireDefault(_ContentNotesClass);

	var _CodeRainClass = __webpack_require__(330);

	var _CodeRainClass2 = _interopRequireDefault(_CodeRainClass);

	var _PictureReel = __webpack_require__(331);

	var _PictureReel2 = _interopRequireDefault(_PictureReel);

	var _Carousel = __webpack_require__(333);

	var _Carousel2 = _interopRequireDefault(_Carousel);

	var _TextFlipper = __webpack_require__(334);

	var _TextFlipper2 = _interopRequireDefault(_TextFlipper);
	...
	$(document).ready(function () {
	  ...
	  nav.on("action", function (target) {
	    notes.showNote(target);
	  });

	  notes.on("show-note", function (activeId) {
	    nav.activateLink(activeId);
	    reel.stop();
	  });

	  $(".header.second-plane").click(function (e) {
	    notes.hideNotes();
	  });

	  notes.on("hide-note", function (activeId) {
	    nav.clear();
	    reel.start();
	  });

	  $(".backgrounds, #rain-container").click(function () {
	    return notes.hideNotes();
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _EventfulClass = __webpack_require__(328);

	var _EventfulClass2 = _interopRequireDefault(_EventfulClass);
	...
	var Nav = function (_Eventful) {
	  _inherits(Nav, _Eventful);
	  ...
	  function Nav() {
	    ...
	    _this.$nav = $("nav");
	    _this.$links = $("nav a:not(.burger)");
	    _this.$burger = $("nav a.burger");
	  ...
	  _createClass(Nav, [{
	    key: "activateLink",
	    value: function activateLink(id) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/**
	  ...
	  */
	var Content = function (_Eventful) {
	  _inherits(Content, _Eventful);

	  function Content(noteSelector, callerSelector) {
	    ...
	    _this.$notes = $(noteSelector);
	    _this.ids = _this.$notes.map(function (a, b) {
	      return this.getAttribute('id');
	    });
	    _this.$notes.velocity({
	      rotateZ: 0,
	      rotateY: 0,
	      translateX: "-50%"
	    }, 0);

	    _this.$notes.on('click', '.close', function () {
	      self.hideNotes();
	    });

	    var close = $("<i>", { class: 'material-icons close' }).text('close');
	    _this.$notes.children(".card").append(close);
	  ...
	  _createClass(Content, [{
	    ...
	    key: "getActiveNote",
	    value: function getActiveNote() {
	      return this.$notes.filter(function (a, b) {
	        return b.classList.contains('active');
	      });
	    }
	  }, {
	    key: "runOrderNotesAnimation",
	    value: function runOrderNotesAnimation() {
	    ...
	    key: "runShuffleNotesAnimation",
	    value: function runShuffleNotesAnimation() {

	      var self = this;

	      return this.$notes.filter(":not(.active)").map(function (a, b) {
	    ...
	    value: function showNote(id) {
	      ...
	      var requestedNote = this.getNoteById("#" + id);
	      var activeNote = this.getActiveNote();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Starry = function (_Eventful) {
	  _inherits(Starry, _Eventful);

	  function Starry(density) {
	  ...
	  _createClass(Starry, [{
	    ...
	    value: function seed(n) {
	      var self = this;
	      Array.from({ length: n }).map(function (a) {
	        return self.spawn();
	      });
	    }
	  }, {
	    ...
	    value: function createStream() {
	      ...
	      var self = this;
	      var steps = self.random().between(5, 30);
	      var node = $("<p>", { class: "stream" });
	      var string = self.random().string();
	      var x = self.random().column(),
	          y = self.random().row();
	    ...
	    value: function random() {
	      ...
	      return {
	        ...
	        row: function row() {
	          return self.random().between(1, 10) * 5 + 'vh';
	        },

	        column: function column() {
	          return self.random().between(3, 47) * 2 + 'vw';
	        },

	        string: function string() {
	          return Array.from({ length: self.random().between(6, 20) }).map(function (a) {
	            return String.fromCharCode(self.random().between(36, 125));
	          }).join("");
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PictureReel = function (_Eventful) {
	  _inherits(PictureReel, _Eventful);

	  function PictureReel() {
	    _classCallCheck(this, PictureReel);

	    var _this = _possibleConstructorReturn(this, (PictureReel.__proto__ || Object.getPrototypeOf(PictureReel)).call(this));

	    _this.data = [];

	    _this.interval = null;

	    _this.sourcePrefix = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1357379/";

	    _this.pictures = [{ ref: "imageedit_35_9563221260.png", data: null }, { ref: "imageedit_11_5857668258.png", data: null }, { ref: "imageedit_16_6199340723.jpg", data: null }, { ref: "imageedit_20_6741302900.png", data: null }, { ref: "imageedit_24_3602036658.png", data: null }, { ref: "imageedit_6_4653672888.png", data: null }];
	  ...
	  _createClass(PictureReel, [{
	    ...
	    value: function getNextPicture() {
	      ...
	      var picture = this.pictures[this.currentSourceIndex];
	    ...
	    key: "createPicture",
	    value: function createPicture(ref) {

	      var self = this;

	      var node = $("<div>", { class: "self-picture" });
	      var source = this.sourcePrefix + ref;
	    ...
	    value: function reel() {
	      ...
	      var picture = this.getNextPicture();
	      var data = picture.data;

	      data.load(function () {
	        if (_this2.currentPicture != null) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Carousel = function (_Eventful) {
	  _inherits(Carousel, _Eventful);

	  function Carousel(selector, height) {
...
/***/ (function(module, exports) {
	...
	var TextFlipper = function () {
	  function TextFlipper(selector, items) {
	    _classCallCheck(this, TextFlipper);
	  ...
	  _createClass(TextFlipper, [{
	    ...
	    value: function flip() {
	      ...
	      var self = this;
	      var nextString = this.getNextString();

	      this.container.velocity({
	        rotateX: 90
	      }, self.flipTime / 2, function () {
